...
## Sets a default font to be used when the specified font in a document is not found
```python
...
## add data table to chart in Word document
```python
...
if isinstance(obj, ShapeObject):
    ...
    chart = shape.Chart 
    data_table = chart.DataTable
    data_table.Show = True
    data_table.ShowLegendKeys = True
    data_table.ShowHorizontalBorder = True
    data_table.ShowVerticalBorder = True
    data_table.ShowOutlineBorder = True
```

---

# spire.doc chart legend
## Add legend to chart in Word document
```python
# Access the first paragraph in the first section of the document
para = doc.Sections[0].Paragraphs[0]
# Get the first child object within the paragraph
...
# spire.doc chart axis formatting
## format chart axes in Word document
```python
# Access the first paragraph in the first section of the document
para = doc.Sections[0].Paragraphs[0]
# Get the first child object within the paragraph
...
# spire.doc chart data label formatting
## Format chart data labels in a Word document
```python
# Access the first paragraph in the first section of the document
para = doc.Sections[0].Paragraphs[0]
# Get the first child object within the paragraph
...
# spire.doc chart axis bounds
## Set bounds and tick intervals for chart axes in a Word document
```python
...
# Append a chart shape to the paragraph
...
# Set the maximum bound of the chart's Y-axis
chart.AxisY.Bounds.Maximum = axisBound_Maximum

# Set the minor tick interval on the X-axis
chart.AxisX.Units.Minor = 10

# Set the major tick interval on the X-axis
