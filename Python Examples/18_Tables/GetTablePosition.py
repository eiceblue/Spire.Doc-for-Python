...
inputFile = "./Data/GetTablePosition.docx"
...
if table.Format.WrapTextAround:
    ...
    stringBuidler += "\n"
    stringBuidler += "Absolute Position:" + str(positon.HorizPositionAbs) + ", Relative to:" + str(positon.HorizRelationTo)
    stringBuidler += "\n"
    stringBuidler += "\n"
    ...
    stringBuidler += "\n"
    stringBuidler += "Absolute Position:" + str(positon.VertPositionAbs) + ", Relative to:" + str(positon.VertRelationTo)
    stringBuidler += "\n"
    stringBuidler += "\n"
    stringBuidler += "Distance from surrounding text:"
    stringBuidler += "\n"
    stringBuidler += "Top:" + str(positon.DistanceFromTop) + " pt, Left:" + str(positon.DistanceFromLeft) + " pt"
    stringBuidler += "\n"
    stringBuidler += "Bottom:" + str(positon.DistanceFromBottom) + "pt, Right:" + str(positon.DistanceFromRight) + " pt"
    stringBuidler += "\n"
